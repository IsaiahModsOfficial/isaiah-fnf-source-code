...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'daschool': //Week 7
				var bg:BGSprite = new BGSprite('schoolhouse', -600, -200, 0.9, 0.9);
				add(bg);
			...
			case 'schoolhousebad': //Week 8
				var bg:BGSprite = new BGSprite('badschool', -600, -200, 0.9, 0.9);
				add(bg);
		}
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'schoolhouse' | 'learning' | 'frustrated' | 'anger':
